...
const AssignTicketDetails = ({ handleGoBack, tickets, setConfirm }) => {
  ...
  const handleConfirm = (_id) => {
    ...
    const url = `https://sleepy-lowlands-62924.herokuapp.com/tickets/${_id}`;
    fetch(url, {
      method: "PUT",
      headers: {
    ...
    <>
      ...
      <Container>
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <Button sx={{ textDecoration: "underline" }} onClick={handleGoBack}>
              Go Back{" "}
            </Button>
        ...
        <AddComment user={user} id={ticket._id} />
      </Container>
    </>
  );
};
